...
public:
    ...
    enum
    {
        numNumbers = LHS::numNumbers + RHS::numNumbers
    };
...
struct OPMult
{
    ...
    static const double leftDerivative(const double l, const double r, const double v)
    {
        return r;
    }

    static const double rightDerivative(const double l, const double r, const double v)
    {
        return l;
    }
};
...
struct OPExp
{
    ...
    static const double derivative(const double r, const double v, const double d)
    {
        return v;
    }
};
...
template <class RHS>
Expression<RHS> operator+(const Expression<RHS> &rhs)
{
    return rhs;
}
